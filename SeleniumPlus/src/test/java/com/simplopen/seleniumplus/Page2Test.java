...
public class Page2Test {
    ...
    */
    ...
    public final void testEcho(){
        String url = "http://localhost:8080/examples/websocket/echo.xhtml";
        PageBean bean = new PageBean();
        bean.setDataname("dataname1");
        bean.setDatavalue("datavalue1");
        composer.visit(url);
        //composer.submit(bean);
        WebElement radio2 = composer.findElement("radio2");
        assertNotNull(radio2);
        radio2.click();
        WebElement btn_connect = composer.findElement("connect");
        btn_connect.click();
        
        WebElement btn_echo = composer.findElement("echo");
        assertNotNull(btn_echo);
        //btn_echo.click();
        
        //WebElement body = driver.findElement(By.xpath("/html/body"));
        System.out.println("all: " + driver.getPageSource());
